...
export const formData = () => async (dispatch) =>{
  try{
      ...
      const data = await axios.post('https://airbnb-backend-eight-omega.vercel.app/api/register',formData)
      dispatch({
...
export const getFormDataAction = () => async (dispatch) =>{
    try{
        ...
        const data = await axios.get('https://airbnb-backend-eight-omega.vercel.app/api/register')
        dispatch({
  ...
  export const getSingleFormDataAction = () => async (dispatch) =>{
    try{
        ...
        const emailId = JSON.parse(localStorage.getItem('emailId'))
        const data = await axios.get(`https://airbnb-backend-eight-omega.vercel.app/api/register/${emailId}`)
        dispatch({
  ...
  export const deleteSingleFormDataAction = (emailId) => async (dispatch) =>{
    try{
        ...
        const data = await axios.delete(`https://airbnb-backend-eight-omega.vercel.app/api/register/${emailId}`)
        dispatch({
  ...
  export const updateFormDataAction = (formData,emailId) => async (dispatch) =>{
    try{
        ...
        const data = await axios.put(`https://airbnb-backend-eight-omega.vercel.app/api/register/${emailId}`,formData)
        dispatch({
